...
export default class PredictionController {
  ...
  public async generatePredictions() {
    await Prediction.generatePredictionsByLeague(135, 12.5, 8, 'under')
    await Prediction.generatePredictionsByLeague(135, 11.5, 8, 'under')
    await Prediction.generatePredictionsByLeague(135, 10.5, 8, 'under')
    await Prediction.generatePredictionsByLeague(135, 9.5, 8, 'under')
    await Prediction.generatePredictionsByLeague(135, 8.5, 8, 'under')
  }
}
